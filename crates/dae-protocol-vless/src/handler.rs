...
impl VlessHandler {
    ...
    /// 添加 SNI 扩展
    fn add_sni_extension(&self, buffer: &mut Vec<u8>, destination: &str) -> Result<(), VlessError> {
    ...
    /// 添加 ALPN 扩展
    fn add_alpn_extension(&self, buffer: &mut Vec<u8>) -> Result<(), VlessError> {
    ...
    fn add_supported_versions_extension(&self, buffer: &mut Vec<u8>) -> Result<(), VlessError> {
        buffer.push(0x00);
        buffer.push(0x2b);
        buffer.push(0x02);
        buffer.push(0x03);
    ...
    /// 添加 psk_modes 扩展
    fn add_psk_modes_extension(&self, buffer: &mut Vec<u8>) -> Result<(), VlessError> {
        buffer.push(0x00);
        buffer.push(0x2d);
        buffer.push(0x02);
        buffer.push(0x01);
